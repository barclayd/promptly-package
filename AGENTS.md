...
CMS display names use dots (e.g. `Codex-sonnet-4.6`), API model IDs use dashes (e.g. `Codex-sonnet-4-6`). Some older models include a date suffix (e.g. `Codex-sonnet-4-5-20250929`).
