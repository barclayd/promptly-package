...
<Aside>
  When you need fine-grained control over the messages array (e.g. for provider options like cache control), use the individual properties from `getPrompt()` instead of `aiParams()`.
</Aside>

## Next steps

- Use [aiParams()](/guides/ai-sdk-integration/) for the simplest AI SDK integration
