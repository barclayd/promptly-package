...
If you have run [codegen](/getting-started/type-generation/), the `input` object is fully typed to the exact variables defined in the CMS. Without codegen, inputs fall back to `Record<string, string>`.
