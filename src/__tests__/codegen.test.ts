...
describe('schemaFieldsToZodSource', () => {
  test('generates simple string field', () => {
  ...
  test('generates field with validations', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'email',
        type: 'string',
  ...
  test('generates field with description', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'name',
        type: 'string',
  ...
  test('generates intersection field', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'combined',
        type: 'intersection',
  ...
  test('generates optional validation', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'nickname',
        type: 'string',
  ...
  test('generates nullable validation', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'middle',
        type: 'string',
  ...
  test('generates default validation with number coercion', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'count',
        type: 'number',
  ...
  test('generates default validation with string', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'name',
        type: 'string',
  ...
  test('generates regex validation', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'code',
        type: 'string',
  ...
  test('generates passthrough object', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'obj',
        type: 'object',
  ...
  test('generates datetime with options', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'ts',
        type: 'string',
  ...
  test('generates ip with version', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'addr',
        type: 'string',
  ...
  test('generates complex multi-field schema', () => {
    const source = schemaFieldsToZodSource([
      field({
        name: 'category',
        type: 'enum',
